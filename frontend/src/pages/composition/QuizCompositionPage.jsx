...
console.log('[QuizCompositionPage] 📤 Réponses formatées avec index:', formattedAnswers);
console.log('[QuizCompositionPage] Questions:', currentQuestionsList.map((q, i) => ({ index: i, id: q._id })));
